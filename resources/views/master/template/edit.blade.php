...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <form class="card" method="post" action="{{ route('master.template.edit', $data->TmpID) }}" enctype="multipart/form-data">
                <div class="card-header">
                    <div class="d-flex flex-row justify-content-between align-items-center">
                        <div class="font-weight-bold">Edit Template Kartu</div>
                        <div class="btn-group">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4 d-flex flex-row justify-content-center">
                        <img src="{{ route('master.template.show_bg', [$data->TmpID, 'depan']) }}" class="img-thumbnail ml-2" style="height: 15rem;" />
                        <img src="{{ route('master.template.show_bg', [$data->TmpID, 'belakang']) }}" class="img-thumbnail ml-2" style="height: 15rem;" />
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="file" class="form-control" id="bgdepan" name="bgdepan" value="{{ old('bgdepan') }}" />
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="bgbelakang" class="col-4 col-form-label">Background Belakang</label>
                        <div class="col-8">
                            <input type="file" class="form-control" id="bgbelakang" name="bgbelakang" value="{{ old('bgbelakang') }}" />
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select class="form-control select2" id="isfoto" name="isfoto" required>
                                <option value="1" {{ $data->IsFoto == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ $data->IsFoto == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select class="form-control select2" id="isnama" name="isnama" required>
                                <option value="1" {{ $data->IsNama == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ $data->IsNama == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select class="form-control select2" id="isnik" name="isnik" required>
                                <option value="1" {{ $data->IsNIK == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ $data->IsNIK == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <select class="form-control select2" id="isrfid" name="isrfid" required>
                                <option value="1" {{ $data->IsRFID == 1 ? 'selected' : '' }}>Ya</option>
                                <option value="0" {{ $data->IsRFID == 0 ? 'selected' : '' }}>Tidak</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-8">
                            <input type="color" class="form-control" id="color" name="color" value="{{ old('color') ?? $data->FontColor }}" required />
                        </div>
                    </div>
                </div>
            </form>
