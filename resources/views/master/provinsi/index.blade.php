...
@section('js')
<script>
    var baseurl = "{{route('master.provinsi.datatable')}}";
    let table = $('.dataTable').dataTable({
        ...
        columns: [
            {data: 'ProvID', name: 'ProvID', searchable: false},
