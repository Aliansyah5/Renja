...
@section('js')
<script>
    var baseurl = "{{route('master.wilayah.datatable')}}";
    let table = $('.dataTable').dataTable({
        ...
        columns: [
            {data: 'WilayahID', name: 'WilayahID', searchable: false},
